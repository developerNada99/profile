  ...
  return (
    <div className=' relative'>
        ...
        <div className=' absolute inset-0 flex flex-col justify-center items-center z-[60] max-md:text-center'>
           ...
           <button className='w-72 h-10 mt-4 text-white font-bold rounded-2xl transition ease-in-out delay-150 bg-[#222222] hover:-translate-y-1 hover:scale-110 hover:bg-yellow-700 duration-300 '>{t("Set Out")}</button>
        </div>
    </div>
  )
}
