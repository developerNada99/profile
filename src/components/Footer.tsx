...
const Contact = () => {
  ...
  const iconClass = "text-lg text-white transition-transform duration-300 hover:scale-110";

  return (
    <div
      id="contact"
      className="p-6 bg-[#222222] flex justify-center items-center gap-4 px-8"
    >
      <Link
